...
void __fastcall TForm_Language::LanguageChange(int LangIndex)
{
    ...
    msgSelect = vle->Values["msgSelect"];
    msgRbtErr = vle->Values["msgRbtErr"];
    msgRstErr = vle->Values["msgRstErr"];
    msgENAErr = vle->Values["msgENAErr"];
    msgNeedRst = vle->Values["msgNeedRst"];
    msgReset = vle->Values["msgReset"];
    msgCheckErr = vle->Values["msgCheckErr"];
}
//---------------------------------------------------------------------------
