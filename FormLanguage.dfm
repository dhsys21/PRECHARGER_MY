object Form_Language: TForm_Language
  ...
  object VLE_KOREAN: TValueListEditor
    ...
    Strings.Strings = (
      ...
      'msgSELECT=[Tray Out] '#46608#45716' [Restart] '#51012' '#49440#53469#54616#49464#50836'.'
      'msgRBTERR=[REBOOT] '#49884#44036#52488#44284'. 60'#52488' '#51060#49345' '#51648#45224'.'
      'msgRSTERR=[RESET] '#49884#44036#52488#44284'. 15'#52488' '#51060#49345' '#51648#45224'.'
      'msgENAERR=ENA '#47749#47161' '#49892#54588'.'
      'msgNeedRst=PreCharger [RESET]'#51060' '#54596#50836#54633#45768#45796'.'
      'msgRESET='#49444#48708#47484' [RESET] '#54616#44256' [SET]'#51012' '#45796#49884' '#49892#54665#54616#49464#50836'.'
      'msgCheckErr='#50640#47084#47484' '#54869#51064#54644' '#51452#49464#50836'.')
    TabOrder = 0
    ColWidths = (
      150
      148)
  ...
  object VLE_ENGLISH: TValueListEditor
    ...
    Strings.Strings = (
      ...
      'msgCellIdError3=the current data will be saved.'
        ...
        'et and try again.'
      'msgSELECT=Select [Tray Out] or [Restart]'
      'msgRBTERR=[REBOOT] is time out. more than 60 sec.'
      'msgRSTERR=[RESET] is time out. more than 15 sec.'
      'msgENAERR=ENA command has fail.'
      'msgNeedRst=PreCharger requires a [RESET].'
      'msgRESET=Please reset and run [SET] it again.'
      'msgCheckErr=Please check the error.')
    TabOrder = 1
    ColWidths = (
      150
      148)
  ...
  object VLE_CHINESE: TValueListEditor
    ...
    Strings.Strings = (
      ...
      'msgSELECT='#35831#36873#25321' [Tray Out] '#25110' [Restart]'#12290
      'msgRBTERR=[REBOOT] '#36229#26102#65292#24050#36229#36807'15'#31186#12290
      'msgRSTERR=[RESET] '#36229#26102#65292#24050#36229#36807'15'#31186#12290
      'msgENAERR=ENA '#25351#20196#22833#36133#12290
      'msgNeedRst='#39044#20805#30005#22120#38656#35201#36827#34892'[RESET]'#12290
      'msgRESET='#35831#25191#34892' [RESET] '#24182#37325#26032#36816#34892' [SET]'#12290
      'msgCheckErr='#35831#26816#26597#38169#35823#12290)
    TabOrder = 2
    ColWidths = (
      150
      148)
