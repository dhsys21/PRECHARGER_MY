...
const int PC_D_PRE_CELL_SERIAL_START                =   20;
const int PC_D_PRE_CELL_SERIAL_COMP                 =   21;
const int PC_D_PRE_CELLID_BYPASS                    =   22;
...
//  실제호출함수
    ...
    AnsiString __fastcall GetPlcString(int plc_address, int size);
