...
void __fastcall TForm_Error::DisplayErrorMessage(int nStage, int nError)
{
	...
	if(!this->Visible)
	{
        ...
        if(nError == nNgErr){
            ...
            msg1 = Form_Language->msgTooManyNG;
            msg2 = Form_Language->msgSelect;
            ...
            msg1 = Form_Language->msgRbtErr;
            msg2 = Form_Language->msgCheckErr;
...
//            msg2 = "Please check the error.";
            ...
            msg1 = Form_Language->msgENAErr;
            msg2 = Form_Language->msgReset;
//            msg1 = "ENA command has fail.";
//            msg2 = "Please reset and run [SET] it again.";

            btnTrayOut->Visible = false;
            btnRestart->Visible = false;
            btnOK->Visible = true;
        } else if(nError == nNeedResetErr){
            title = "PreCharger #" + IntToStr(nStage + 1) + " RESET ERROR";
            msg1 = Form_Language->msgNeedRst;
            msg2 = Form_Language->msgReset;
            //msg1 = "PreCharger requires a [RESET].";
            //msg2 = "Please reset and [SET] it again.";
